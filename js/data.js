...
const CLIENT_LOGOS = [
  // Row 1
  { name: 'Bashundhara', sector: 'Real Estate', image: 'asset/clients/01.png' },
  { name: 'SGS', sector: 'Services', image: 'asset/clients/02.png' },
  { name: 'Studio 32', sector: 'Media', image: 'asset/clients/03.webp' },
  { name: 'Walton', sector: 'Electronics', image: 'asset/clients/04.png' },
  { name: 'Sader', sector: 'Services', image: 'asset/clients/05.png' },
  { name: 'ISC', sector: 'Technology', image: 'asset/clients/06.png' },
  { name: 'Malek Spinning', sector: 'Textile & Garments', image: 'asset/clients/07.jpg' },
  { name: 'BEACON', sector: 'Services', image: 'asset/clients/08.jpg' },
  { name: 'Bangladesh Land', sector: 'Real Estate', image: 'asset/clients/09.jpg' },
  { name: 'United Group', sector: 'Conglomerate', image: 'asset/clients/10.jpg' },
  { name: 'CCI', sector: 'Services', image: 'asset/clients/11.jpg' },
  { name: 'Seamark', sector: 'Logistics', image: 'asset/clients/12.jpg' },
  { name: 'Foring', sector: 'Services', image: 'asset/clients/13.png' },
  { name: 'MGI', sector: 'Services', image: 'asset/clients/14.png' },
  { name: 'BAT', sector: 'FMCG', image: 'asset/clients/15.png' },
  { name: 'PLCS', sector: 'Services', image: 'asset/clients/16.png' },
  { name: 'ASCEND', sector: 'Technology', image: 'asset/clients/17.jpg' },
  { name: 'Zisan', sector: 'Services', image: 'asset/clients/18.gif' },

  // Row 2
  { name: 'BASIS', sector: 'Technology', image: 'asset/clients/19.jpg' },
  { name: 'Texvista', sector: 'Textile & Garments', image: 'asset/clients/20.png' },
  { name: 'Channel I', sector: 'Media', image: 'asset/clients/21.png' },
  { name: 'Expressway', sector: 'Infrastructure', image: 'asset/clients/22.png' },
  { name: 'Sachatan', sector: 'Services', image: 'asset/clients/23.webp' },
  { name: 'FASTER', sector: 'Logistics', image: 'asset/clients/24.jpg' },
  { name: 'Nagarbajzar', sector: 'Real Estate', image: 'asset/clients/25.jpg' },
  { name: 'Bobby', sector: 'Services', image: 'asset/clients/26.jpg' },
  { name: 'Kazi Farms', sector: 'Agro', image: 'asset/clients/27.png' },
  { name: 'Tiger', sector: 'Services', image: 'asset/clients/28.png' },
  { name: 'Chef\'s Cuisine', sector: 'Food & Beverage', image: 'asset/clients/29.png' },
  { name: 'CCU IMP', sector: 'Services', image: 'asset/clients/30.jpg' },
  { name: 'SEBL', sector: 'Banking', image: 'asset/clients/31.jpg' },
  { name: 'Urea', sector: 'Agro', image: 'asset/clients/32.png' },
  { name: 'Jhakor', sector: 'Services', image: 'asset/clients/33.jpg' },
  { name: 'Azad Printers', sector: 'Services', image: 'asset/clients/34.jpg' },
  { name: 'Kazi Farm', sector: 'Agro', image: 'asset/clients/35.jpg' },

  // Row 3
  { name: 'Cafe 71', sector: 'Food & Beverage', image: 'asset/clients/36.jpg' },
  { name: 'Eat & Eat', sector: 'Food & Beverage', image: 'asset/clients/37.jpg' },
  { name: 'Indian Restaurant', sector: 'Food & Beverage', image: 'asset/clients/38.jpg' },
  { name: 'Tasty Foods', sector: 'Food & Beverage', image: 'asset/clients/39.png' },
  { name: 'Mr. Manik', sector: 'Food & Beverage', image: 'asset/clients/40.jpg' },
  { name: 'Mackee Baby', sector: 'FMCG', image: 'asset/clients/41.jpg' },
  { name: 'Panta Fresh', sector: 'Food & Beverage', image: 'asset/clients/42.jpg' },
  { name: 'Frego Cafe', sector: 'Food & Beverage', image: 'asset/clients/43.png' },
  { name: 'State of Foods', sector: 'Food & Beverage', image: 'asset/clients/44.jpg' },
  { name: 'Expressway', sector: 'Infrastructure', image: 'asset/clients/45.png' },
  { name: 'K Family', sector: 'Services', image: 'asset/clients/46.png' },
  { name: 'Akanda', sector: 'Real Estate', image: 'asset/clients/47.jpg' },
  { name: 'Paradise Restaurant', sector: 'Food & Beverage', image: 'asset/clients/48.jpg' },
  { name: 'Peri-Peri Grill', sector: 'Food & Beverage', image: 'asset/clients/49.png' },
  { name: 'FastTv.com', sector: 'Media', image: 'asset/clients/50.jpg' },
  { name: 'FBL', sector: 'Banking', image: 'asset/clients/51.png' },
  { name: 'TAANZ', sector: 'Services', image: 'asset/clients/52.png' },

  // Row 4
  { name: 'Charuni', sector: 'Services', image: 'asset/clients/53.jpg' },
  { name: 'GCCI', sector: 'Services', image: 'asset/clients/54.jpg' },
  { name: 'Good America', sector: 'FMCG', image: 'asset/clients/55.jpg' },
  { name: 'SPL', sector: 'Services', image: 'asset/clients/56.jpg' },
  { name: 'MF Foods', sector: 'Food & Beverage', image: 'asset/clients/57.jpg' },
  { name: 'MK', sector: 'Services', image: 'asset/clients/58.jpg' },
  { name: 'Xiaomi', sector: 'Technology', image: 'asset/clients/59.png' },
  { name: 'ACME', sector: 'Services', image: 'asset/clients/60.jpg' },
  { name: 'Bangla Insider', sector: 'Media', image: 'asset/clients/61.png' },
  { name: 'Mong', sector: 'Agro', image: 'asset/clients/62.jpg' },
  { name: 'Tilottoma', sector: 'Agro', image: 'asset/clients/63.jpg' },
  { name: 'Evince', sector: 'Textile & Garments', image: 'asset/clients/64.jpg' },
  { name: 'Metro Express', sector: 'Logistics', image: 'asset/clients/65.jpg' },
  { name: 'Cocomaya', sector: 'Food & Beverage', image: 'asset/clients/66.jpg' },
  { name: 'Eastern', sector: 'Services', image: 'asset/clients/67.png' },
  { name: 'IBN', sector: 'Banking', image: 'asset/clients/68.png' },
  { name: 'Simco', sector: 'Services', image: 'asset/clients/69.png' },

  // Row 5
  { name: 'Sonali', sector: 'Banking', image: 'asset/clients/70.png' },
  { name: 'Agrani', sector: 'Banking', image: 'asset/clients/71.png' },
  { name: 'ICB', sector: 'Banking', image: 'asset/clients/72.png' },
  { name: 'AFC', sector: 'Banking', image: 'asset/clients/73.jpg' },
  { name: 'ICS', sector: 'Technology', image: 'asset/clients/74.png' },
  { name: 'Prime', sector: 'Banking', image: 'asset/clients/75.png' },
  { name: 'JBL', sector: 'Banking', image: 'asset/clients/76.png' },
  { name: 'China', sector: 'Banking', image: 'asset/clients/77.png' },
  { name: 'Bangladesh Bank', sector: 'Banking', image: 'asset/clients/78.png' },
  { name: 'DBC', sector: 'Banking', image: 'asset/clients/79.png' },
  { name: 'BCL', sector: 'Banking', image: 'asset/clients/80.png' },
  { name: 'DBBL', sector: 'Banking', image: 'asset/clients/81.png' },
  { name: 'Premier', sector: 'Banking', image: 'asset/clients/82.png' },
  { name: 'Bangla', sector: 'Banking', image: 'asset/clients/83.png' },
  { name: 'Dhaka', sector: 'Banking', image: 'asset/clients/84.png' },
  { name: 'Rupali', sector: 'Banking', image: 'asset/clients/85.png' },
  { name: 'Karmasangsthan', sector: 'Banking', image: 'asset/clients/86.png' },

  // Row 6
  { name: 'Krishak', sector: 'Banking', image: 'asset/clients/87.png' },
  { name: 'Rajshahi', sector: 'Banking', image: 'asset/clients/88.png' },
  { name: 'SIBL', sector: 'Banking', image: 'asset/clients/89.png' },
  { name: 'Social', sector: 'Banking', image: 'asset/clients/90.jpg' },
  { name: 'NRB', sector: 'Banking', image: 'asset/clients/91.png' },
  { name: 'Standard', sector: 'Banking', image: 'asset/clients/92.png' },
  { name: 'Global', sector: 'Banking', image: 'asset/clients/93.jpg' },
  { name: 'NCC', sector: 'Banking', image: 'asset/clients/94.png' },
  { name: 'Trust', sector: 'Banking', image: 'asset/clients/95.png' },
  { name: 'Midland', sector: 'Banking', image: 'asset/clients/96.png' },
  { name: 'Shahjalal', sector: 'Banking', image: 'asset/clients/97.jpg' },
  { name: 'IFIC', sector: 'Banking', image: 'asset/clients/98.jpg' },
  { name: 'Southeast', sector: 'Banking', image: 'asset/clients/99.jpg' },
  { name: 'EWU', sector: 'Education', image: 'asset/clients/100.png' },
  { name: 'BAF', sector: 'Banking', image: 'asset/clients/101.jpg' },
  { name: 'Uttara', sector: 'Banking', image: 'asset/clients/102.jpg' },
  { name: 'Commercial', sector: 'Banking', image: 'asset/clients/103.jpg' },
  { name: 'Padma', sector: 'Banking', image: 'asset/clients/104.png' },

  // Row 7
  { name: 'BUET', sector: 'Education', image: 'asset/clients/105.jpg' },
  { name: 'Green Delta', sector: 'Services', image: 'asset/clients/106.jpg' },
  { name: 'DU', sector: 'Education', image: 'asset/clients/107.jpg' },
  { name: 'DIU', sector: 'Education', image: 'asset/clients/108.png' },
  { name: 'Sylhet', sector: 'Banking', image: 'asset/clients/109.jpg' },
  { name: 'UFS', sector: 'Services', image: 'asset/clients/110.jpg' },
  { name: 'Nobin', sector: 'Banking', image: 'asset/clients/111.png' },
  { name: 'Shimanto', sector: 'Banking', image: 'asset/clients/112.jpg' },
  { name: 'Grameen', sector: 'Banking', image: 'asset/clients/113.jpg' },
  { name: 'FRI', sector: 'Services', image: 'asset/clients/114.jpg' },
  { name: 'GU', sector: 'Education', image: 'asset/clients/115.png' },
  { name: 'UBL', sector: 'Banking', image: 'asset/clients/116.jpg' },
  { name: 'Kishoreganj', sector: 'Banking', image: 'asset/clients/117.jpg' },
];
